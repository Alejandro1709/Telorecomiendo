	...
	return (
		<div className='m-2 bg-white rounded-md overflow-hidden shadow-md'>
			...
			<div className='flex flex-col p-2'>
				<div className='flex flex-col justify-center gap-1 md:gap-0.5 mb-2 md:mb-4'>
				...
				<div className='flex flex-row items-center justify-between'>
					...
					<span className='font-semibold text-gray-500'><span className='text-yellow-400 font-bold'>90USD</span>/NIGHT</span>
				</div>
			</div>
		</div>
	)
